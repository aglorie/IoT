sap.ui.define([
	...
	"application1/model/formatter"
], function (Controller, formatter) {
	"use strict";

	return Controller.extend("application1.controller.ThingPage", {
		formatter: formatter,
		onInit: function () {
		...
		_readDetailsService: function (oDetailsModel, sThingId) {
			...
			oDetailsModel.read("/Things('" + sThingId + "')", {
				urlParameters: {
					"$expand": "DYN_ENT_iot_529406714d2841ad82361fa3bc692b1d_packagealex__Position,DYN_ENT_iot_529406714d2841ad82361fa3bc692b1d_packagealex__Vehicle,DYN_ENT_iot_529406714d2841ad82361fa3bc692b1d_packagealex__DefaultImagePropertySet"
				},
